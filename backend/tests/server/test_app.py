...
class ServerAppTestCase(unittest.TestCase):
    ...
    def test_root_does_not_serve_static_frontend(self) -> None:
        """FastAPI chỉ cung cấp API và không phục vụ frontend tại route gốc."""
        # Bước 1: gọi route gốc để xác nhận không còn static mount bắt request.
